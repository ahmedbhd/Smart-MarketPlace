    ...
    if (purchasesNbr!=""){
        ...
        tab.forEach(function (item) {
            ...
            purchases.push( {
                    ...
                    "_buyer": thisHouse[1],
                    "_bank": thisHouse[2],
                    "_insurance": thisHouse[3],
                    "_houseIndex":item,
                    "_loan" : thisHouse[4],
                    "_date" : thisHouse[5],
                    "_advance": thisHouse[3],
                    "_amountPerMonthForBank":item,
                    "_amountPerMonthForInsurance" : thisHouse[4],
                    "_sellerConfirmation" : thisHouse[5],
                    "_buyerConfirmation" : thisHouse[5]
                })
        });
    }
    res.json(houses);
