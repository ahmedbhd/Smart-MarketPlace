...
function initiateEvents(){
    ...
    confirmedEvent.watch(function(error, result){
        if (!error)
        {
            ...
            let purchaseLoanStr = tokenContract.getPurchaseLoanAt(purchaseIndex,{from: clearingHouseAccount, gas:3000000 });
            ...
            if (purchaseLoan == 0){
                ...
                confirmPurchaseWithLoan(owner, buyer, price, houseIndex);
            }
        } else {
            console.log(error);
        }
...
function confirmPurchaseWithLoan(owner, buyer, price, houseIndex){
