...
app.get('/getPurchases', (req, res) => {
    let purchases =[]
    let purchasesNbr = proxyContract.getPurchasesNbr({from:clearingHouseAccount,gas:3000000 });
    if (purchasesNbr!=""){
        purchasesNbr = housesNbr.slice(0,housesNbr.length-1);
        ...
        tab.forEach(function (item) {
            ...
            purchases.push( {
                    "indexHouse": item,
                    "_owner" : purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_buyer":purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_bank": purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_insurance": purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_houseIndex":purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_loan" : purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_date" :purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_advance": purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_amountPerMonthForBank":purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_amountPerMonthForInsurance" : purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_sellerConfirmation" : purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 }),
                    "_buyerConfirmation" : purchase.getPurchaseAt({from:clearingHouseAccount,gas:3000000 })
                })
        });
    }
    res.json(houses);
...
function PurchaseWithLoan(houseIndex,from){
    proxyContract.setHousePending(houseIndex,from, {from: clearingHouseAccount, gas:3000000 });
}