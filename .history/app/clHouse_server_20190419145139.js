...
function upFrontPurchase(houseIndex,buyer){
    let d = new Date("Tue Feb 23 2016 20:11:42 GMT+0200 (WAT)");
    let timeStamp = d.getTime();
    proxyContract.addInProgressPurchase(0,houseIndex,buyer,web3.eth.address(0),web3.eth.address(0),"0", {from: clearingHouseAccount, gas:3000000 });
}
