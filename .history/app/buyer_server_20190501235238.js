    ...
    console.log(item);
            ...
            if ( (buyer == buyerAccount) && (buyerConfir == false)){
                purchases = {
                        ...
                        "loan" : purthisPurchasechase.getLoan({from:buyerAccount,gas:3000000 }),
                        ...
                        "sellerConfirmation" : purthisPurchasechase.getSellerConfirmation({from:buyerAccount,gas:3000000 }),
