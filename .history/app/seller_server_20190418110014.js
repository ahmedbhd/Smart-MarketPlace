...
app.post('/addHouse', (req, res) => {
    ...
    proxyContract.addHouse(req.body.location, req.body.area,req.body.rooms, req.body.price, req.body.image,{from:sellerAccount,
        ...
        tab.forEach(function (item) {
            ...
            let thisHouse = proxyContract.getHouseAt(item,{from:sellerAccount,
                ...
                houses.push( {
                    ...
                    "image" : thisHouse[4],
                    "owner" : thisHouse[5],
                    "buyer" : proxyContract.getHouseBuyerAt(item,{from:sellerAccount,gas:3000000 })
                })
        });
    }
    res.json(houses);
