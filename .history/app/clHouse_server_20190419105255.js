    ...
    wantedEvent.watch(function(error, result){
        if (!error)
        {
            ...
            if (buyerBalance >= price){
                ...
                doThePurchase(houseIndex,buyer);
            }else{
...
function doThePurchase(houseIndex,buyer){
    proxyContract.setHouseInProgress(houseIndex,buyer, {from: clearingHouseAccount, gas:3000000 });
}

function doThePurchase(houseIndex,from){
