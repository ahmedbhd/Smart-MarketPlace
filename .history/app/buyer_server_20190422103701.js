...
app.get('/getMyPendingPurchases', (req, res) => {
    let purchases =[]
    let purchasesNbr = proxyContract.getPurchaseAt({from:buyerAccount,gas:3000000 });
    ...
    if (purchasesNbr!=""){
        ...
        tab.forEach(function (item) {
            ...
            let buyer = purchase.getBuyer({from:sellerAccount,gas:3000000 });
            let buyerConfir = purchase.getBuyerConfirmation({from:sellerAccount,gas:3000000 });
