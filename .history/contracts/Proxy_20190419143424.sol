...
contract Proxy{
    ...
    function addInProgressPurchase(uint256 _purchaseIndex,uint256 _houseIndex, address _bank, address _insurance, string memory _loan,string memory _date,string memory _forBank,string memory _forInsurance) public returns (bool){
        if (_purchaseIndex ==0){
            _purchasesNumber++;
    ...
    function setHouseInProgress(uint256 _index, address _owner, address _buyer) public returns (bool) {
