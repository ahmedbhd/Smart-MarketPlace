...
contract House {
    string private _descLocationAreaRoomsImgReview;
    ...
    function setArguments (string memory descLocationArea,string memory history,uint256 price,address owner) public {
        _descLocationAreaRoomsImgReview=descLocationArea;
        _price=price;
        _state=0;
        _owner=owner;
        _history=history;
    ...
    function getDescLocationAreaRoomsImgReview() public view returns(string memory){
        return _descLocationAreaRoomsImgReview;
    }
    function setDescLocationAreaRoomsImgReview(string memory _infos) public{
        _descLocationAreaRoomsImgReview=_infos;
    }
