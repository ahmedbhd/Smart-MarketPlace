...
contract Proxy{
    ...
    function getPurchaseAt(uint256 _index) public view returns(Purchase ,string memory,uint256){
        string memory _strings = _houses[_purchases[_index].purchase.getHouseIndex()].house.getLocation();
        return (_purchases[_index].purchase,_strings,_purchases[_index].purchase.getHouseIndex());
    }
