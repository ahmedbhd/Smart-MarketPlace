...
contract Proxy{
   ...
   /*  function getPurchasesNbr() public view returns (uint256){
    ...
    function getHouseAt(uint256 _index) public view returns(string memory, string memory, uint, uint, uint, string memory, address, address ){
        return (
            _houses[_index].getLocation(),
            _houses[_index].getArea(),
             _houses[_index].getRooms(),
