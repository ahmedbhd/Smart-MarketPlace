...
contract Proxy{
    ...
    function setPurchaseAsConfirmed(uint256 _purchaseIndex) public returns (bool){
        _purchases[_purchaseIndex].setBuyerConfirmation();
        uint256 = _purchases[_purchaseIndex].getHouseIndex();
        _setHouseAsConfirmed(_purchases[_purchaseIndex].getHouseIndex(),_purchases[_purchaseIndex].getOwner(),_purchases[_purchaseIndex].getBuyer(),_purchases[_purchaseIndex].getPrice());
        return (true);
    }
