...
contract Proxy{
    ...
    function addInProgressPurchase(uint256 _purchaseIndex,uint256 _houseIndex, address _buyer, address _bank, address _insurance, string memory _loan,uint256 _date,string memory _forBank,string memory _forInsurance) public returns (bool){
        if (_purchaseIndex ==0){
            _purchasesNumber++;
