...
contract Purchase {
    ...
    function getStrings() public view returns(string memory,string memory,string memory,string memory,string memory,bool){
        return(_ref,_loan,_advance,_amountPerMonthForBank,_amountPerMonthForInsurance,_buyerConfirmation);
    }
