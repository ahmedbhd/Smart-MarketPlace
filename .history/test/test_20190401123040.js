...
//const provider = new Web3.providers.HttpProvider("http://localhost:8501");
 ...
 const deploySC = async () => {
     let accounts = await web3.eth.getAccounts();
      ...
      const deployContract = await new web3.eth.Contract(JSON.parse(interface) ,{ from: accounts[0], gas:5000000 , data: bytecode} );
    ...
    .on('receipt', (receipt) => {
        ...
        deployContract.options.address = receipt.contractAddress;
    });
