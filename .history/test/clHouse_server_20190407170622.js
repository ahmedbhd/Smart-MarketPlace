...
function initiateEvents(){
    ...
    if (!error)
    {
        ...
        tokenContract.transferHouseFrom(buyer,owner,price,{from:clearingHouseAccount,gas:3000000 });
        ...
        proxyContract.transferFrom(owner,buyer,result.args._homeIndex,currentBuyerBalance,
